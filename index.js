...
const getJokeBtn = document.getElementById("jokeButton"); // add id
const jokeText = document.getElementById("jokeP"); // add id
...
function apiCall() { 
    ...
    fetch("https://api.api-ninjas.com/v1/jokes?limit=1", { // add event request url
        headers: { 'X-Api-Key': 'Yeu3FElpA1IUCW8xLh0I4w==GdVZb4SSmoDNTbM2' } // add api key
    })
